...
int ttl_output = 5;  //port for forwarding input; 5
int ttl_input = 4;  //port for notifying received TTL pulse; 4
...
int ttl_output_debounce_time = 200; //debounce time; ms
int ttl_input_debounce_time = 200; //debounce time; ms
