...
int aPin = 9;   // pushbutton connected to digital pin 9
int sPin = 10;   // pushbutton connected to digital pin 10
int dPin = 11;   // pushbutton connected to digital pin 11
int pressed = 0;
...
void loop(void)
{
  ...
  if (pressed) {
    ...
    if (a_voltage == LOW && s_voltage == LOW && d_voltage == LOW) {
      pressed = 0;
